...
<body>
    ...
    <div class="home-page">
        ...
        <div class="introduction">
            <img alt="" src="images/myself.jpg">
            <div class="mask">
            </div>
            <div class="intro-content">
                <h1>HELLO<br>
                I'M <span>VELMURUGAN</span></h1>
        ...
        <div class="content-container col-md-7 col-sm-12">
            ...
            <div class="story clearfix">
                ...
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="story-content clearfix">
                        <img alt="" src="images/myself.jpg" class="col-xs-offset-1 col-sm-offset-0 col-sm-4 col-xs-10">
                        <div class="col-sm-8 col-xs-12">
                            <h3>AN AWESOME DEVELOPER ON COMPANY</h3>
                            <p>
            ...
            <div class="services-container clearfix">
                ...
                <div class="services col-lg-4 col-md-6 col-sm-4">
                    <img src="https://png.icons8.com/php/color/96" title="PHP" width="80" height="80">
                ...
                <div class="services col-lg-4 col-md-6 col-sm-4">
                    <img src="https://png.icons8.com/js/color/96" title="JS" width="80" height="80">
                    <h3>ANGULAR JS, NODE JS</h3>
                    <p>
                ...
                <div class="services col-lg-4 col-md-6 col-sm-4">
                    <img src="https://png.icons8.com/initial-state/ultraviolet/80" title="Initial State" width="80" height="80">
                    <h3>IONIC</h3>
                    <p>
                ...
                <div class="education-container col-lg-10 col-lg-offset-1 col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                    <div class="item">
                        ...
                        <div class="education-content">
                            <h3>B.E COMPUTER SCIENCE<span> / AUG 2013 - March 2017</span></h3>
                            <p>
                    ...
                    <div class="item">
                        ...
                        <div class="education-content">
                            <h3>HR.SEC.SCHOOL <span> / JUNE 2011 - March 2013</span></h3>
                            <p>
                    ...
                    <div class="item">
                        ...
                        <div class="education-content">
                            <h3>SSLC <span> / JUNE 2010 - March 2011</span></h3>
                            <p>
                ...
                <div class="experience-container col-lg-10 col-lg-offset-1 col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-1">
                    <div class="item">
                        ...
                        <div class="experience-content">
                            <h3>Junior Software Developer<span> / June 2017 - Still<br>
                            Smaatapps Technologies.</span></h3>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris et pulvinar ligula. Praesent maximus ornare quam, id consectetur dui eleifend nec. Nam consectetur orci id nulla varius, quis facilisis dui vulputate. Sed ultrices eu erat non mollis. Phasellus ut libero.
                            </p>
                        </div>
                    ...
                    <div class="item">
                        ...
                        <div class="experience-content">
                            <h3>Web Developer<span> / Nov 2016 - Apr 2017<br>
                            Itbay Inc.</span></h3>
                            <p>
                                In eu semper velit. Ut laoreet, sapien ac porta aliquam, est enim blandit nisl, ut semper dui justo a sapien. Nam orci ipsum, rutrum semper purus a, posuere molestie lorem. Sed ut nibh lobortis, semper ligula ut, tempus mi. In.
                            </p>
                    ...
                    <div class="item">
                        ...
                        <div class="experience-content">
                            <h3>Web & Mobile App Developer<span> / Aug 2016 - Oct 2016<br>
                            Centurycloud Solution.</span></h3>
                            <p>
                                Maecenas hendrerit euismod lorem, vitae mollis odio consectetur a. Aliquam at viverra nunc. Fusce neque lectus, vehicula eget lectus ac, consequat mollis erat. Sed sed interdum nisl. Nulla maximus odio vitae turpis rhoncus tempus. Donec vel elit quis metus rutrum.
                            </p>
                        </div>
    ...
    <div class="contact-page">
        ...
        <div class="content-container col-md-7 col-sm-12">
            ...
            <div >
                <iframe class="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.8673876227986!2d80.23125246437539!3d12.980332600512332!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525d783e132a2b%3A0xde19da73ec4f5a77!2sThamirabarani+St%2C+Bharathi+Nagar%2C+Velachery%2C+Chennai%2C+Tamil+Nadu+600113!5e0!3m2!1sen!2sin!4v1504117702910" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
                ...
                <div class="contact col-sm-4">
                    <p>
                        <i class="fa fa-map-marker"></i><br>
                         UMR Hostel, Perungudi, chennai-600096
                    </p>
                </div>
...
<!-- Mirrored from demos.compiledtech.com/demo/insta/preview/index.green.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Aug 2017 17:07:52 GMT -->
</html>
